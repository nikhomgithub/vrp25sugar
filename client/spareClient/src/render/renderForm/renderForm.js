...
const renderForm=({
    ...
    const changeInputState=({location,value})=>{
        ...
        //console.log('changeInputState')

        let temp= refAndValue

        if(calculation){
          temp=calculation({location,value,refAndValue})
        }
    ...
    const renderEachInputType=({
        ...
        if(inputType=="select"){
            ...
            const renderSelectCondition=()=>{
              ...
              ////เงื่อนไข 3
              else if(selectData[selectDataKey].id){
        ...
        //=======================
          ...
          if(calculation){
            ...
            if(calculation.method=="total"){
             
              refAndValue[calculation.param[0]].map(i=>{
                const temp1=i[calculation.param[1]].value
                const temp2=i[calculation.param[2]].value
                calValue=temp1*temp2+calValue
              })

            }
            if(calculation.method=="grandTotal"){
                
                const temp0=refAndValue[calculation.param[3]].value
              ...
              calValue=calValue-temp0
            }

           
          }//if(calculation)
          
          value={calculation?calValue:value}
            ...
            <div className={subCName[1]} 
                ...
                { 
                  renderEachInputType({
                    ...
                    placeholder,disabled,autoFocus,unchangeable,
                    selectObj,selectDataKey,
                    location,nextRef,ref,value,textRow,
                    //calculation
                  })
                }
            </div>
