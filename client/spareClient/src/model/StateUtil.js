  ...
  const genFunction=({tPt,stObj,refObj})=>{
        ...
        arrayTemplate.map((tpKey,tpIdx)=>{  
                ...
                if(stType=="object"){
                  ...
                  //console.log(`arrayObject ${tpKey} : 0`)
                  stObj[tpKey]=[{}]
                  refObj[tpKey]=[{}]
                  genFunction({
                    tPt:stChildren,
...
//======================
const convertFitlerDataToGraphData=({template,filterData,inputState,totalSwapPage})=>{
  ...
  const genCommonObject=(i)=>{
          ...
          arrayTemplate.map((tpKey,idx)=>{
              if(template[tpKey].stType=="string") {
                  if(i[tpKey]){
  ...
  //console.log('tempAllDetail')
  //console.log(tempAllDetail)
  //console.log('tempNoDetail')
  //console.log(tempNoDetail)
  ...
  //console.log('arrayToShowDetailInputState')
  //console.log(arrayToShowDetailInputState)
