  ...
  return (
    <div className="page-center">
        ...
        <div className="w-50 h-40 ">
            ...
            >   
                {!haveUserToken
                ?<h1 style={{fontSize:"2rem",textAlign:"center"}}>ล็อกอิน พนักงานก่อนใช้</h1>
                :<h1 style={{fontSize:"2rem",textAlign:"center"}}>{`ยินดีต้อนรับ : ${userName}`}</h1>
                }
            </div>
            
            <div className="flex-center-center h-30">

                <div className="xc4 sc12 p-1" style={{display:!haveUserToken?"none":"block"}}>
